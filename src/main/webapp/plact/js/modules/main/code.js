//import LibTemplate from "./modules/main/mef.js";
...
$(document).ready(function(){
    ...
    var $mefModeElement = $("mef-mode#codemirrorMode").first();
    if($mefModeElement && $mefModeElement.data("modeName")){     
        CodeMirror.modeURL = $mefModeElement.data("modeUrl")?"plact/js/codemirror/mode/%N/%N.js":$mefModeElement.data("modeUrl");
