...
import org.elsquatrecaps.flexiblelearning.responses.ResponseAction;
...
import org.elsquatrecaps.flexiblelearning.activity.ActivityCategory;
import org.elsquatrecaps.flexiblelearning.activity.Activity;
import org.elsquatrecaps.flexiblelearning.activity.SimpleActivity;
...
//    }
    ...
    private static void updateProgressBarState(Student student, Activity activity) {
        ...
        NavComponents nav =(NavComponents) activity.getObjects().floor(new NamedObject("navComponents",null)).getObject();
