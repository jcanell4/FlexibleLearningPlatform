...
public interface ResponseViewComposer {
    ...
    */
    ...
    li arribessin objectes amb les dades especifiques necessaries per cada tipologia). Això redueix l'acoblament, ja que si es passa  l'estudiant, l'Attemp i la Task, 
